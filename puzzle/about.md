...
<p class="archive-eyebrow">ABOUT THIS ARCHIVE</p>
...
Mathematical puzzles, logic games, geometry, probability, number theory, algorithms, board problems, and collections such as Project Euler or IBM Ponder This. Occasionally a puzzle grows into a longer note; those live beside the archive rather than inside the solution.

## A small editorial rule

> The interface should recede. The problem, diagram, and argument should hold the page.
