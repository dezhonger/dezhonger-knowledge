...
export const messages = {
  en: {
    ...
    nav: { puzzles: 'Puzzles', collections: 'Collections', notes: 'Notes', timeline: 'Timeline', about: 'About', rss: 'RSS' },
    search: 'Search',
  ...
  zh: {
    ...
    nav: { puzzles: '谜题', collections: '题集', notes: '笔记', timeline: '时间线', about: '关于', rss: '订阅' },
    search: '搜索',
    searchLabel: '搜索谜题库',
